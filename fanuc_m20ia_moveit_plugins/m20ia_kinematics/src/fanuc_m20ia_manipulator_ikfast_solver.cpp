...
///
/// ikfast version 0x10000049 generated on 2020-06-16 06:16:48.317922
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
x44=((((-1.0)*x17*x5))+x41);
x45=(((x0*x5))+x42);
x46=(((x5*((x29+(((-1.0)*x22*x24))))))+(((-1.0)*x17*x6)));
x47=(((x0*x6))+((x5*(((((-1.0)*x17*x24))+x30)))));
eerot[0]=(((x9*((((x0*x26))+((x0*x25))))))+((x44*x8)));
eerot[1]=(((x11*x46))+((x10*(((((-1.0)*x15*x44))+(((-1.0)*x13*x39)))))));
eerot[2]=(((x10*x46))+((x11*((((x44*x9))+((x39*x8)))))));
eetrans[0]=(((x9*((((x18*x26))+((x18*x25))))))+((x8*(((((-1.0)*x16*x5))+((x14*x36))))))+((x0*x20))+((x19*x25))+((x19*x26))+(((-1.0)*x12*x27))+x12+((x12*x24)));
eerot[3]=(((x9*((((x26*x7))+((x25*x7))))))+((x45*x8)));
eerot[4]=(((x11*x47))+((x10*(((((-1.0)*x15*x45))+(((-1.0)*x13*x40)))))));
eerot[5]=(((x10*x47))+((x11*((x43+((x45*x9)))))));
eetrans[1]=((((-1.0)*x21*x27))+((x8*((((x18*x5))+((x14*x37))))))+((x21*x24))+((x23*x26))+((x23*x25))+x21+((x20*x7))+((x9*((((x16*x26))+((x16*x25)))))));
eerot[6]=(((x34*x8))+((x9*(((((-1.0)*x28))+x27)))));
eerot[7]=(((x10*(((((-1.0)*x13*x32))+(((-1.0)*x15*x34))))))+((x11*x38)));
eerot[8]=(((x10*x38))+((x11*((((x34*x9))+x35)))));
eetrans[2]=((0.525)+(((0.79)*x3))+((x9*(((((-0.1)*x24))+(((0.1)*x27))))))+((x6*x8*(((((0.1)*x25))+(((0.1)*x26))))))+(((-0.86)*x24))+(((0.15)*x25))+(((0.15)*x26))+(((0.86)*x27)));
}
...
if( (((0.988680054243382)+(((-0.724998206528843)*pp))+(((0.217499461958653)*cj0*px))+(((0.217499461958653)*py*sj0)))) < -1-IKFAST_SINCOS_THRESH || (((0.988680054243382)+(((-0.724998206528843)*pp))+(((0.217499461958653)*cj0*px))+(((0.217499461958653)*py*sj0)))) > 1+IKFAST_SINCOS_THRESH )
    continue;
IkReal x53=IKasin(((0.988680054243382)+(((-0.724998206528843)*pp))+(((0.217499461958653)*cj0*px))+(((0.217499461958653)*py*sj0))));
j2array[0]=((-0.172681491618005)+(((-1.0)*x53)));
sj2array[0]=IKsin(j2array[0]);
cj2array[0]=IKcos(j2array[0]);
j2array[1]=((2.96891116197179)+x53);
...
IkReal x62=(cj2*x57);
j1eval[0]=((((-1.0)*sj2))+(((6.66666666666667)*cj2*pz))+(((-38.2222222222222)*x62))+(((35.1111111111111)*pz))+((x57*x61))+((x56*x61))+(((5.73333333333333)*cj2))+(((38.2222222222222)*x60))+(((-38.2222222222222)*cj2*x56)));
j1eval[1]=IKsign((((cj2*x59))+(((-0.86)*cj2*x56))+(((-0.0225)*sj2))+(((0.86)*x60))+(((-0.86)*x62))+(((0.129)*cj2))+(((0.79)*pz))+((x55*x56))+((x55*x57))));
j1eval[2]=((IKabs(((-0.0225)+(((0.258)*x58))+(pz*pz)+(((-0.7171)*x54)))))+(IKabs(((0.129)+(((-0.6794)*cj2))+(((0.1185)*sj2))+(((-0.7171)*x58))+(((-0.258)*x54))+((pz*x56))+((pz*x57))+(((-1.0)*x59))))));
...
IkReal x63=(pz*sj2);
IkReal x64=(cj0*px);
IkReal x65=((38.2222222222222)*sj2);
IkReal x66=((0.15)*cj2);
IkReal x67=(py*sj0);
IkReal x68=(cj2*pz);
IkReal x69=((0.86)*sj2);
IkReal x70=((6.66666666666667)*cj2);
j1eval[0]=((5.26666666666667)+cj2+(((-35.1111111111111)*x67))+(((-35.1111111111111)*x64))+(((-38.2222222222222)*x68))+(((6.66666666666667)*x63))+(((5.73333333333333)*sj2))+(((-1.0)*x64*x65))+(((-1.0)*x67*x70))+(((-1.0)*x65*x67))+(((-1.0)*x64*x70)));
j1eval[1]=IKsign(((0.1185)+(((-1.0)*x66*x67))+(((0.129)*sj2))+(((-0.79)*x64))+(((-0.79)*x67))+(((-0.86)*x68))+(((-1.0)*x67*x69))+(((0.15)*x63))+(((-1.0)*x64*x69))+(((-1.0)*x64*x66))+(((0.0225)*cj2))));
...
IkReal x77=(x71*x72);
IkReal x78=(x72*x73);
j1eval[0]=((-1.0)+(((44.4444444444444)*x77))+(((-44.4444444444444)*x78))+(((-44.4444444444444)*x71))+(((-44.4444444444444)*x74))+(((-88.8888888888889)*x75*x76))+(((13.3333333333333)*x75))+(((13.3333333333333)*x76)));
j1eval[1]=IKsign(((-0.0225)+(((-2.0)*x75*x76))+x77+(((-1.0)*x78))+(((-1.0)*x74))+(((-1.0)*x71))+(((0.3)*x76))+(((0.3)*x75))));
if( IKabs(j1eval[0]) < 0.0000010000000000  || IKabs(j1eval[1]) < 0.0000010000000000  )
{
...
IkReal x85=((0.15)*cj2);
IkReal x86=((0.15)*sj2);
CheckValue<IkReal> x87=IKPowWithIntegerCheck(IKsign(((-0.0225)+((x79*x80))+(((-1.0)*x80*(px*px)))+(((0.3)*x81))+(((0.3)*x83))+(((-2.0)*x81*x83))+(((-1.0)*(pz*pz)))+(((-1.0)*x79)))),-1);
if(!x87.valid){
continue;
}
CheckValue<IkReal> x88 = IKatan2WithCheck(IkReal(((0.1185)+(((-1.0)*x81*x84))+(((-1.0)*x81*x85))+(((0.129)*sj2))+(((-0.79)*x83))+(((-0.79)*x81))+(((-1.0)*x83*x85))+(((-1.0)*x83*x84))+((pz*x82))+(((-1.0)*pz*x86))+(((0.0225)*cj2)))),IkReal(((((-1.0)*x81*x82))+(((-1.0)*x82*x83))+(((-0.0225)*sj2))+((x81*x86))+(((-0.79)*pz))+(((0.129)*cj2))+((x83*x86))+(((-1.0)*pz*x84))+(((-1.0)*pz*x85)))),IKFAST_ATAN2_MAGTHRESH);
if(!x88.valid){
continue;
}
...
IkReal x98=((0.15)*x89);
IkReal x99=((0.15)*x90);
evalcond[0]=((((-1.0)*x91*x97))+((pz*x90))+x98+x93+(((-1.0)*x92*x97))+(((-0.15)*sj2)));
evalcond[1]=((((-1.0)*sj2*x99))+(((-0.79)*x89))+((x90*x93))+pz+(((-1.0)*cj2*x98))+(((-1.0)*x89*x94)));
evalcond[2]=((0.79)+(((-1.0)*pz*x97))+(((-1.0)*x91*x95))+x99+x94+(((-1.0)*x92*x95))+(((0.15)*cj2)));
evalcond[3]=((0.1155)+(((0.3)*x92))+(((0.3)*x91))+((x92*x96))+(((-0.237)*x90))+(((1.58)*pz*x89))+(((-1.0)*pp))+((x91*x96)));
evalcond[4]=((0.15)+(((-1.0)*sj2*x98))+((x89*x93))+((cj2*x99))+((x90*x94))+(((-1.0)*x92))+(((-1.0)*x91))+(((0.79)*x90)));
...
IkReal x1520=(py*sj0);
IkReal x1521=((0.86)*sj2);
IkReal x1522=((0.15)*cj2);
IkReal x1523=(cj0*px);
IkReal x1524=((0.15)*pz);
IkReal x1525=(cj2*sj2);
IkReal x1526=((1.0)*pz);
CheckValue<IkReal> x1527=IKPowWithIntegerCheck(IKsign(((0.1185)+(((0.129)*sj2))+((sj2*x1524))+(((-0.86)*cj2*pz))+(((-1.0)*x1522*x1523))+(((-1.0)*x1520*x1521))+(((-1.0)*x1520*x1522))+(((-0.79)*x1520))+(((-0.79)*x1523))+(((-1.0)*x1521*x1523))+(((0.0225)*cj2)))),-1);
if(!x1527.valid){
continue;
}
CheckValue<IkReal> x1528 = IKatan2WithCheck(IkReal(((-1.3637)+(((-1.3588)*sj2))+(((-0.258)*x1525))+(pz*pz)+(((0.7171)*x1519))+(((-0.237)*cj2)))),IkReal(((0.129)+(((-0.258)*x1519))+(((-0.6794)*cj2))+x1524+(((0.1185)*sj2))+(((-1.0)*x1523*x1526))+(((-0.7171)*x1525))+(((-1.0)*x1520*x1526)))),IKFAST_ATAN2_MAGTHRESH);
if(!x1528.valid){
continue;
}
j1array[0]=((-1.5707963267949)+(((1.5707963267949)*(x1527.value)))+(x1528.value));
sj1array[0]=IKsin(j1array[0]);
cj1array[0]=IKcos(j1array[0]);
if( j1array[0] > IKPI )
{
...
IkReal x1531=(cj0*px);
IkReal x1532=(py*sj0);
IkReal x1533=((0.86)*cj2);
IkReal x1534=((0.86)*sj2);
IkReal x1535=((1.0)*x1530);
IkReal x1536=((1.58)*x1530);
IkReal x1537=((1.0)*x1529);
IkReal x1538=((0.15)*x1529);
IkReal x1539=((0.15)*x1530);
evalcond[0]=((((-1.0)*x1531*x1537))+(((-1.0)*x1532*x1537))+x1533+x1538+(((-0.15)*sj2))+((pz*x1530)));
evalcond[1]=((((-1.0)*x1529*x1534))+(((-1.0)*sj2*x1539))+((x1530*x1533))+pz+(((-1.0)*cj2*x1538))+(((-0.79)*x1529)));
evalcond[2]=((0.79)+(((-1.0)*x1531*x1535))+(((-1.0)*x1532*x1535))+x1534+x1539+(((0.15)*cj2))+(((-1.0)*pz*x1537)));
evalcond[3]=((0.1155)+((x1531*x1536))+((x1532*x1536))+(((-1.0)*pp))+(((-0.237)*x1530))+(((0.3)*x1532))+(((0.3)*x1531))+(((1.58)*pz*x1529)));
evalcond[4]=((0.15)+(((0.79)*x1530))+(((-1.0)*x1532))+(((-1.0)*x1531))+(((-1.0)*sj2*x1538))+((cj2*x1539))+((x1530*x1534))+((x1529*x1533)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1542=(py*sj0);
IkReal x1543=((0.86)*cj2);
IkReal x1544=((0.15)*sj2);
IkReal x1545=(cj0*px);
IkReal x1546=((0.15)*pz);
CheckValue<IkReal> x1547=IKPowWithIntegerCheck(IKsign(((((-1.0)*x1543*x1545))+(((-0.0225)*sj2))+((x1544*x1545))+(((0.129)*cj2))+(((0.79)*pz))+((cj2*x1546))+(((0.86)*pz*sj2))+(((-1.0)*x1542*x1543))+((x1542*x1544)))),-1);
if(!x1547.valid){
continue;
}
CheckValue<IkReal> x1548 = IKatan2WithCheck(IkReal(((0.129)+(((-0.7171)*x1541))+(((-0.258)*x1540))+(((-0.6794)*cj2))+(((0.1185)*sj2))+((pz*x1542))+((pz*x1545))+(((-1.0)*x1546)))),IkReal(((-0.0225)+(((-0.7171)*x1540))+(((0.258)*x1541))+(pz*pz))),IKFAST_ATAN2_MAGTHRESH);
if(!x1548.valid){
continue;
}
...
IkReal x1551=(cj0*px);
IkReal x1552=(py*sj0);
IkReal x1553=((0.86)*cj2);
IkReal x1554=((0.86)*sj2);
IkReal x1555=((1.0)*x1550);
IkReal x1556=((1.58)*x1550);
IkReal x1557=((1.0)*x1549);
IkReal x1558=((0.15)*x1549);
IkReal x1559=((0.15)*x1550);
evalcond[0]=((((-1.0)*x1552*x1557))+x1553+x1558+((pz*x1550))+(((-1.0)*x1551*x1557))+(((-0.15)*sj2)));
evalcond[1]=((((-1.0)*x1549*x1554))+((x1550*x1553))+(((-0.79)*x1549))+pz+(((-1.0)*cj2*x1558))+(((-1.0)*sj2*x1559)));
evalcond[2]=((0.79)+(((-1.0)*pz*x1557))+(((-1.0)*x1552*x1555))+x1554+x1559+(((-1.0)*x1551*x1555))+(((0.15)*cj2)));
evalcond[3]=((0.1155)+((x1551*x1556))+((x1552*x1556))+(((1.58)*pz*x1549))+(((-1.0)*pp))+(((0.3)*x1552))+(((0.3)*x1551))+(((-0.237)*x1550)));
evalcond[4]=((0.15)+(((0.79)*x1550))+(((-1.0)*x1552))+(((-1.0)*x1551))+((x1550*x1554))+((cj2*x1559))+((x1549*x1553))+(((-1.0)*sj2*x1558)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IKFAST_API const char* GetKinematicsHash() { return "d5b465b089f6a1c685cbd3ff8a4e13ba"; }
